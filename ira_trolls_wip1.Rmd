...
stargazer(outdegree_table, summary=F, align=T, title="Top 10 Users ranked by Outdegree", rownames=F)
stargazer(w_outdegree_table, summary=F, align=T, title="Top 10 Users ranked by Weighted Outdegree", rownames=F)
...
## to investigate in R
kable(rank.indegree[1:10,], caption = "Top 10 Users ranked by indegree", label = "out")
kable(rank.indegree.w[1:10,], caption = "Top 10 Users ranked by weighted indegree", label = "wout")
...
stargazer(indegree_table, summary=F, align=T, title="Top 10 Users ranked by Indegree", rownames=F, label = "in")
stargazer(w_indegree_table, summary=F, align=T, title="Top 10 Users ranked by Weighted Indegree", rownames=F, label = "win")
```
...
panel.background = element_blank(), axis.line = element_line(colour = "black"), legend.position="right") + xlab("Outdegree") + ylab("Indegree")
```
