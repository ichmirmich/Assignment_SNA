...
V(g)$modularity <- modularity$memberships
...
stargazer(outdegree_table, summary=F, align=T, title="Top 10 Users ranked by Outdegree")
stargazer(w_outdegree_table, summary=F, align=T, title="Top 10 Users ranked by Weighted Outdegree")
...
stargazer(indegree_table, summary=F, align=T, title="Top 10 Users ranked by Indegree")
stargazer(w_indegree_table, summary=F, align=T, title="Top 10 Users ranked by Weighted Indegree")
```
