...
\caption{Distribution of account categories by Linvill and Warren. Color reflects account categories among communities detected by the Louvain Method.}
\label{fig:distcom}
\end{figure}
...
\caption{Distribution of account categories among communities detected by the Louvain Method. Color reflects account categories by Linvill and Warren.}
\label{fig:distcat}
\end{figure}
